...
import {FaShare, FaBath, FaBed, FaChair, FaMapMarkerAlt, FaParking} from 'react-icons/fa';
...
export default function Listing() {
    ...
    useEffect(()=>{
        const fetchListing = async () => {
            try {
                setLoading(true);
                const res = await fetch (`${process.env.REACT_APP_SERVER}/api/listing/get/${params.listingId}`);
